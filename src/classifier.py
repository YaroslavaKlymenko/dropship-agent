...
СТИЛЬ:
- Вітання з іменем відправника, якщо воно є в тексті листа (шукай підпис або звертання: \
"Олена", "Марія", "Іван" тощо у формі "Доброго дня, Олено!" / "Привіт, Іване!"). \
Якщо імені немає — "Доброго дня!"
